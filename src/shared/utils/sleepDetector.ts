 ...
 */
export function correctSessionAfterSleep(session: IConcentrationSession, _sleptMs: number): IConcentrationSession {
 ...
 */
export function getCorrectedVisibleTime(session: IConcentrationSession): number {
