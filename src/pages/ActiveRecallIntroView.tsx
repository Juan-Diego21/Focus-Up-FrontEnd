...
export const ActiveRecallIntroView: React.FC = () => {
  ...
  const handleStartMethod = () => {
    window.location.href = `/active-recall/steps/${id}`;
  };
      ...
      <div className="w-full max-w-4xl space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-300 text-lg leading-relaxed max-w-2xl mx-auto">
            Practica la recuperación de información sin mirar tus notas para fortalecer la memoria y profundizar la comprensión.
          </p>
        </div>

        {/* Timeline de práctica activa */}
          ...
          <div className="grid gap-6">
            ...
            >
              ...
              <p className="text-gray-300 leading-relaxed">
                Intenta recuperar conceptos sin mirar tus notas.
              </p>
            </div>
